		...
		<body id="page-top">
			...
			<nav class="navbar navbar-expand-lg navbar-light fixed-top py-0" id="mainNav">
				<div class="container px-4 px-lg-8">
					...
					<div class="logoImage" style="margin-left: -5vh;">
						<a class="navbar-brand" href=" ${contextRoot}/"> <img class="barimg"
								src=" ${contextRoot}/image/index/logo.png">
						</a>
					</div>
					<div class="logoImage">
					...
					<div class="collapse navbar-collapse" id="navbarResponsive">
						<ul class="navbar-nav ms-auto my-2 my-lg-0">
							...
							<!--      -------------------------------------------------------------------------- -->
							<li class="nav-item"><a class="nav-link" href="${contextRoot}/Order/page">訂單資訊</a></li>
							<!--       -------------------------------------------------------------------------- -->
							<c:choose>
								<c:when test="${empty memberId}">
									<li class="nav-item">
										<a class="nav-link" href="${contextRoot}/login"> 訪客 </a>
									</li>
								</c:when>
								<c:when test="${memberId.equals('A123123')}">
									<li class="nav-item">
										<a class="nav-link" href="${contextRoot}/management/allManagement"> 使用者：${name}
										</a>
									</li>

									<li class="nav-item">
										<a class="nav-link" href="#" data-toggle="modal" data-target="#logoutModal">登
											出</a>
									</li>
								</c:when>
								<c:otherwise>
									<li class="nav-item">
										<a class="nav-link" href="${contextRoot}/user"> 使用者:${name}</a>
									</li>
									<li class="nav-item">
										<a class="nav-link" data-toggle="modal" data-target="#logoutModal"></a>
									</li>
								</c:otherwise>
							</c:choose>
						</ul>
